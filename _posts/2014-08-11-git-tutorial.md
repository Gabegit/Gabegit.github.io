---
layout: post
title: "git skills for beginners"
---
...
$$\frac{x}{y}=\sum_{x=1}^{100} + y$$

add the following lines in my layout `default.html`
...
- `git diff filename1` 查看filename1到底修改:了哪些内容
- `git log` 查看最近的提交日志
...
- `git mv oldname newname` rename a file or directory
